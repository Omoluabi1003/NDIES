...
export function Nav() {
  return <header className="sticky top-0 z-50 border-b border-white/10 bg-[#03170f]/90 backdrop-blur-xl">
    <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
      <Link href="/" className="flex items-center gap-3" aria-label="NDIES home">
        <span className="relative h-12 w-12 overflow-hidden rounded-2xl border border-[#f2c94c]/35 bg-[#010805] shadow-[0_0_28px_rgba(17,184,111,.22)]">
          <Image src="/assets/brand/ndies-icon-compact.png" alt="" fill sizes="48px" className="object-cover" priority />
        </span>
        <span>
