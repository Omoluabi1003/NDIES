  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <Card>
        ...
        <button disabled={loading} onClick={classify} className="mt-4 rounded-full bg-[#f2c94c] px-6 py-3 font-semibold text-[#06291c] disabled:cursor-not-allowed disabled:opacity-60">
      ...
      <Card>
        ...
        <pre className="mt-5 max-h-[520px] overflow-auto rounded-2xl bg-[#010805] p-5 text-sm text-[#11b86f]">
